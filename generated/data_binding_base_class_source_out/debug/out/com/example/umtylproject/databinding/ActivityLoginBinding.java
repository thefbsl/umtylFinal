...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnLogin,
      @NonNull TextView btnRegister, @NonNull EditText etEmail, @NonNull EditText etPassword,
      @NonNull TextView forgotTw, @NonNull ImageView imageView, @NonNull ImageView imageView2,
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, btnLogin, btnRegister, etEmail,
          etPassword, forgotTw, imageView, imageView2, textView2);
    }
